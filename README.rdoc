...
If you need information for set up Ruby on Rails on your machine, you can visit [Setup Link](https://gorails.com/setup "Setup Ruby on Rails on your machine")
...
* client_id & client_secret is provided from Instagram client manager API, at [Instagram Developer Link](https://instagram.com/developer/ "Register and get your own Id") 

* user_id is User id of Instagram member, you can look up for your instagram id, at [Lookup User Id Jelled Link](jelled.com/instagram/lookup-user-id "Lookup User Id Instagram") 
